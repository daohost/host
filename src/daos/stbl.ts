...
import {ContractIndices, FundingType, IDAOData, LifecyclePhase, UnitStatus, UnitType} from "../host.types";
...
export const stbl: IDAOData = {
  ...
  deployments: {
    ["146"]: {
      ...
      [ContractIndices.X_TOKEN_4]: "0x902215dd96a291b256a3aef6c4dee62d2a9b80cb",
      [ContractIndices.STAKING_6]: "0x17a7cf838a7c91de47552a9f65822b547f9a6997",
    ...
    ["9745"]: {
      ...
      [ContractIndices.X_TOKEN_4]: "0xF40D0724599282CaF9dfb66feB630e936bC0CFBE",
      [ContractIndices.STAKING_6]: "0x601572b91DC054Be500392A6d3e15c690140998D",
      [ContractIndices.REVENUE_ROUTER_21]:
  ...
  unitEmitData: [
    ...
    },
    {
      ...
      pool: {
        ...
        label: {
          name: "STBL:Lending",
          description: "Lending feature, product request or maintenance issue",
          color: "#3b15d2",
        },
      },
    },
